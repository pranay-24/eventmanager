...
It has features like role based access control, authentication. A user can view the events/tasks and an admin can create a new user/new event and assign tasks for a user
...
Home page - List of Events with Functionality for CRUD
